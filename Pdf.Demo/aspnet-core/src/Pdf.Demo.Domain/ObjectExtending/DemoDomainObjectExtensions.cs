...
namespace Pdf.Demo.ObjectExtending
{
    public static class DemoDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the DemoEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
